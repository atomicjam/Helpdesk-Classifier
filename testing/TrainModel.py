...
# Check dataset
#print("\nNumber of labels loaded:", len(labels))
#print("\nNumber of titles loaded:", len(sentences))
...
#Predict 
sentence = ["My computer monitor is flashing", "my toilet is broken", "chairs in s111 need moving", "Can i have a new toner", "how do i set the voicemail on my phone", "we have a flood in room 45", "parking needed for sat 2nd"]
